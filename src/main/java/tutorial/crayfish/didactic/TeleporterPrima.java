...
//                        int i2 = k + i1 * b1 - l * b0;
//                        boolean flag = j1 < 0;
//                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? TutorialMod.blockTable : Blocks.air);
//                    }
//                }
//            }
//
...
//                        if(this.worldServerInstance.getBlock(l3, i2, l1) == TutorialMod.blockArenaPortal){
//                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) ==
//                                    TutorialMod.blockArenaPortal){
//                                --i2;
//                            }
...
//            int i4 = -1;
//
//            if(this.worldServerInstance.getBlock(i - 1, j, k) == TutorialMod.blockArenaPortal){
//                i4 = 2;
//            }
//
//            if(this.worldServerInstance.getBlock(i + 1, j, k) == TutorialMod.blockArenaPortal){
...
//            }
//
//            if(this.worldServerInstance.getBlock(i, j, k - 1) == TutorialMod.blockArenaPortal){
//                i4 = 3;
//            }
//
//            if(this.worldServerInstance.getBlock(i, j, k + 1) == TutorialMod.blockArenaPortal){
